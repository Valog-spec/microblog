...
database_url = (
    ...
    f"localhost:{app_settings.POSTGRES_PORT}/{app_settings.POSTGRES_DB}"
)
...
def include_object(object, name, type_, reflected, compare_to):
    if type_ == "table" and (  # noqa: PIE801
        name.startswith("auth") or name.startswith("django")
    ):
        return False
    else:
        return True
